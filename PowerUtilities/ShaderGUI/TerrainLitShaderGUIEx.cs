...
{
    internal class TerrainLitShaderGUIEx : UnityEditor.ShaderGUI, ITerrainLayerCustomUI
    {
        ...
        public override void OnGUI(MaterialEditor materialEditorIn, MaterialProperty[] properties)
        {
            ...
            //var isEnableHeightBlend = enableHeightBlend.floatValue > 0;
            //var isPixelNormal = enableInstancedPerPixelNormal.floatValue > 0;
            //materialEditorIn.targets.ForEach( material =>
            //{
            //    CoreUtils.SetKeyword((Material)material, "_TERRAIN_BLEND_HEIGHT", isEnableHeightBlend);
            //    CoreUtils.SetKeyword((Material)material, "_TERRAIN_INSTANCED_PERPIXEL_NORMAL", isPixelNormal);
            //});
