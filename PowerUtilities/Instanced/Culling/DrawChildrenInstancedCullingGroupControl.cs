...
namespace PowerUtilities
{
    ...
    public class DrawChildrenInstancedCullingGroupControlEditor : PowerEditor<DrawChildrenInstancedCullingGroupControl>
    {
        ...
        public override void DrawInspectorUI(DrawChildrenInstancedCullingGroupControl inst)
        {
            if (!inst.cullingProfile)
            {
                ...
                inst.cullingProfile = ScriptableObjectTools.CreateGetInstance<InstancedCullingGroupSO>(path);
            }
    ...
    {
        public InstancedCullingGroupSO cullingProfile;
        ...
        public static InstancedCullingGroupSO GetProfle(string scenePath = "")
        {
            ...
            {
                var path = $"{AssetDatabaseTools.CreateGetSceneFolder()}/CullingProfile.asset";
                GetInstance().cullingProfile = ScriptableObjectTools.CreateGetInstance<InstancedCullingGroupSO>(path);
            }
#endif
            return GetInstance().cullingProfile;
        }

        public static InstancedCullingGroupSO SceneProfile => GetProfle();
